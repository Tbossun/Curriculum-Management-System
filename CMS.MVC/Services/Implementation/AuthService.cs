...
namespace CMS.MVC.Services.Implementation
{
    ...
    public class AuthService : IAuthService
    {
        ...
        public AuthService(AppDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, SignInManager<ApplicationUser> signinManager, IEmailService emailService, IMapper mapper)
        {
            _context = context;
